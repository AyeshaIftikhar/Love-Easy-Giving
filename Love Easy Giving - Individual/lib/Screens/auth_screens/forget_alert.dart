        ...
        child: Column(
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(left:30.0, right: 30),
              child: appText(
                text: 'If you do not receive the email within 5 minutes, then please check your spam folder.',
                fontSize: 18,
              ),
            ),
            vspace(height: 50),
            Container(
              ...
              child: ElevatedButton(
                ...
                child: appText(text: 'Close', fontSize: 17, fontWeight: FontWeight.bold, alignment: Alignment.center, color: primaryColor),
