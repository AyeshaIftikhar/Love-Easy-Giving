        ...
        child: Container(
          child: Column(
            ...
            children: [
              ...
              Obx(() => Container(
                width: 300,
                color: _appController.isRamadan.value && !_appController.isHajj.value
                  ? Colors.grey
                  : !_appController.isRamadan.value && !_appController.isHajj.value
                    ? Colors.grey
                    : null,
                child: HomeGestures(
                      ...
                      onTap: _appController.isHajj.value &&
                          ...
                          : ()=>showToast(message: 'Looks like the time of Hajj is not arrived yet.'),
                    ),
              )),
              vspace(height: 20),
              HomeGestures(
                child: 'assets/images/LoveJummah/lovejummah.png',
                onTap: () => Get.toNamed('/jummah', parameters: {
                          'app': 'individual',
                        }),
              ),
              vspace(height: 20),
              Obx(() => Container(
                width: 300,
                color: _appController.isHajj.value && _appController.isRamadan.value == false 
                  ? Colors.grey 
                  : !_appController.isRamadan.value && !_appController.isHajj.value
                    ? Colors.grey
                    : null,
                child: HomeGestures(
                      ...
                      onTap: _appController.isRamadan.value && !_appController.isHajj.value
                          ? () => Get.toNamed('/ramadan', parameters: {
                            'app': 'individual',
                          })
                          : ()=> showToast(message: 'Looks like the time of Ramadan is not arrived yet.'),
                    ),
              )),
              vspace(height: 20),
              bottomDecor(height: 160.5,
                width: 321,),
            ],
          ),
        ),
