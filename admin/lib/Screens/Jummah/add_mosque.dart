...
class AddGeneralMosques extends StatefulWidget {
  const AddGeneralMosques({Key? key}) : super(key: key);

  @override
  State<AddGeneralMosques> createState() => _AddGeneralMosquesState();
}

class _AddGeneralMosquesState extends State<AddGeneralMosques> {
  final MyAppController _app = Get.find();
  var addGeneralMosques = GlobalKey<FormState>();
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            if (addGeneralMosques.currentState!.validate()) {
                              _app.mosqueRef.add({
                                'Name': name.text,
                                'Address': {
                                ...
                                // Get.back();
                                Get.offAllNamed('/Mosque');
                              });
                              addGeneralMosques.currentState!.save();
                            }
                          },
