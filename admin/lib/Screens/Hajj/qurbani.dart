...
class Qurbani extends StatelessWidget {
  Qurbani({Key? key}) : super(key: key);
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          Align(
            ...
            child: Container(
              ...
              child: OutlinedButton.icon(
                onPressed: () => Get.toNamed('/QurbaniBasket'),
                icon: const Icon(
                  Icons.edit_outlined,
                  color: Color(0xff6B5233),
                ),
                label: const TextWidget(
                  text: 'Add New Qurbani Basket',
                  color: Color(0xff6B5233),
          ...
          StreamBuilder(
              stream: _app.charityRef.snapshots(),
