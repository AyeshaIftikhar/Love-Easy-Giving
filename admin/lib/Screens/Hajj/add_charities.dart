...
class AddHajjCharities extends StatefulWidget {
  const AddHajjCharities({Key? key}) : super(key: key);

  @override
  State<AddHajjCharities> createState() => _AddHajjCharitiesState();
}

class _AddHajjCharitiesState extends State<AddHajjCharities> {
  final MyAppController _app = Get.find();
  var addHajjCharities = GlobalKey<FormState>();
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            if (addHajjCharities.currentState!.validate()) {
                              _app.charityRef.add({
                                'Name': name.text,
                                'cName': name.text,
                              ...
                              addHajjCharities.currentState!.save();
                            }
                          },
