...
class RamadanCause extends StatelessWidget {
  RamadanCause({Key? key}) : super(key: key);
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          Align(
            ...
            child: Container(
              ...
              child: OutlinedButton.icon(
                onPressed: () => Get.toNamed('/AddCharityCause'),
                icon: const Icon(
                  Icons.edit_outlined,
          ...
          StreamBuilder(
              stream: _app.causesRef.snapshots(),
                          ...
                          child: Card(
                            ...
                            child: ListTile(
                              ...
                              subtitle: Padding(
                                ...
                                child: TextWidget(
                                  text:
                                      'Cause Type: ${snapshot.data.docs[index].get('type')}\nPrice: \u00A3${snapshot.data.docs[index].get('price')}',
                                  lineHeight: 1.5,
                                ),
