                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Align(
                              alignment: 
                              // backgroundColor == loveJummahScaffold? Alignment.topLeft: 
                              Alignment.center,
                              child: Container(
                                width: 160,
                                ...
                                child: ElevatedButton(
                                  style: elevatedButton(
                                    primary: backgroundColor == loveJummahScaffold ? Colors.grey : selectColor,
                                  ),
                                  onPressed: () async {
                                    _controller.cancelPaymentRef.add({
                                      ...
                                      'AppType': appmode,
                                      'appmode': app,
                                      'unicode': snapshot.data.docs[index].get('unicode')
                                    });
